...
router.patch('/:id/estado', verificarRol('ADMIN', 'COCINERO', 'MOZO', 'DELIVERY'), validate({ params: idParamSchema, body: cambiarEstadoBodySchema }), asyncHandler(pedidosController.cambiarEstado));
